...
public class CreateProcessorTest {
    ...
    void create_one_checking_account_is_successful() {
        createProcessor.createAccount("create checking 12345678 1.0");
    ...
    void create_multiple_checking_accounts_is_successful() {
        createProcessor.createAccount("create checking 12345678 1.0");
        createProcessor.createAccount("create checking 10101010 2.0");
        createProcessor.createAccount("create checking 12121212 3.6");
    ...
    void create_one_savings_account_is_successful() {
        createProcessor.createAccount("create savings 12345678 1.0");
        Account actual = bank.getAccounts().get("12345678");
        assertTrue(bank.getAccounts().containsKey("12345678"));
        assertEquals(actual.getId(), "12345678");
        assertEquals(actual.getApr(), 1.0);
    ...
    void create_multiple_savings_accounts_is_successful() {
        createProcessor.createAccount("create savings 12345678 1.0");
        createProcessor.createAccount("create savings 12121212 2.3");
        createProcessor.createAccount("create savings 10101010 3.2");
        Account actual1 = bank.getAccounts().get("12345678");
        Account actual2 = bank.getAccounts().get("10101010");
        Account actual3 = bank.getAccounts().get("12121212");
        assertTrue(bank.getAccounts().containsKey("12345678"));
    ...
    void create_cd_account_is_successful() {
        createProcessor.createAccount("create cd 12345678 1.0 2000");
        Account actual = bank.getAccounts().get("12345678");
        assertTrue(bank.getAccounts().containsKey("12345678"));
        assertEquals(actual.getId(), "12345678");
        assertEquals(actual.getId(), "12345678");
    ...
    void create_multiple_cd_accounts_is_successful() {
        createProcessor.createAccount("create cd 12345678 1.0 2000");
        createProcessor.createAccount("create cd 12121212 2.3 5000");
        createProcessor.createAccount("create cd 10101010 3.2 6000");
        Account actual1 = bank.getAccounts().get("12345678");
        Account actual2 = bank.getAccounts().get("10101010");
        Account actual3 = bank.getAccounts().get("12121212");
        assertTrue(bank.getAccounts().containsKey("12345678"));
    ...
    void create_cd_checking_and_savings_account_is_successful() {
        createProcessor.createAccount("create checking 12345678 1.0");
        createProcessor.createAccount("create savings 12121212 2.0");
        createProcessor.createAccount("create cd 10101010 3.2 2000");
        Account actual1 = bank.getAccounts().get("12345678");
